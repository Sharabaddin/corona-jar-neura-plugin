...
local function infuseStringsWithGoogleServicesJson(android, srcDir, package)
	...
	if not jsonFileHandle then
		return "The Google Services settings file (usually google-services.json) is required by setting.android.useGoogleServicesJson, but file not exist: " .. tostring( jsonFile )
	end
